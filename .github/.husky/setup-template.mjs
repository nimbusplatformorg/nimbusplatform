...
executeCommand(`cd bloc && npx hardhat run scripts/template/Box/deployBox.ts`);
...
console.log(
  ...
  "🐵 $ git remote add origin git@github.com:[YourRepositoryName/YourName]/[YourProjectName].git 🐵\n",
